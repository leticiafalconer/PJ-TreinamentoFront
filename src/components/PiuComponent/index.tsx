...
const PiuComponent: React.FC<PiuComponentProps> = ({
    id,
    name,
    profileImg,
    likes,
    ...
    useEffect(() => {
        const updateLikes = async () => {
            const result = likes.find(
                ({ userId }) =>
                    userId === '08e5be8d-3225-4816-a36f-d39990a11eba'
            );
    ...
    return (
        <S.Container>
            ...
            <S.PiuBottomWrapper>
                ...
                <S.CreationDate>
                    Piado em {new Date(created_at).toLocaleDateString()} às{' '}
